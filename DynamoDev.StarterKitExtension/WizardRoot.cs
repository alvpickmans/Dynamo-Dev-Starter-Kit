...
namespace DynamoDev.StarterKitExtension
{
    public class WizardRoot : IWizard
    {
            ...
            WizardRunKind runKind, object[] customParams)
        {
            ...
            {
                viewModel.AddAssembly(replacementsDictionary["$safeprojectname$"] + ".Functions", "1.0.0.0");
                WizardTitle = String.Format(WizardTitle, "Explicit Nodes");
                IsSingleProjectWizard = false;
            }
            else
            {
                WizardTitle = String.Format(WizardTitle, "ZeroTouch");
            }
