...
namespace $safeprojectname$
{
    ...
    /// </summary>
    public class $projectname$ViewExtension : IViewExtension
    {
        ...
        public void Loaded(ViewLoadedParams p)
        {
            ...
            {
                var viewModel = new $safeprojectname$WindowViewModel(p);
                var window = new $safeprojectname$Window
                {
        ...
        public string Name
        {
            get
            {
                return "$safeprojectname$ View Extension";
            }
        }
